 ...
 */
interface NativeTor {
    startDaemon(timeoutMs: number, clientTimeoutSeconds: number): Promise<SocksPortNumber>;
...
declare const _default: ({ stopDaemonOnBackground, startDaemonOnActive, bootstrapTimeoutMs, numberConcurrentRequests, clientTimeoutSeconds, os, }?: {
    ...
    clientTimeoutSeconds?: number | undefined;
